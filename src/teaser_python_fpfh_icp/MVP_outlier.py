...
point_arr = (copy.deepcopy(complete_cloud[random_pair_num,:,:].reshape(-1,3)))
...
cloud.points = o3d.utility.Vector3dVector(copy.deepcopy(complete_cloud[random_pair_num,:,:].reshape(-1,3)))
